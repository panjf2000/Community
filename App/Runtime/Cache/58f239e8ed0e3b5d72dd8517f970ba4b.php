        ...
        <div class="row">
                    ...
                    <div class="content-list">
                            ...
                            <select name='type' id='topic_type'>
								...
								<?php if(is_array($category)): foreach($category as $key=>$vo): ?><option value="<?php echo ($vo["_id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
                            ...
                            <a href="javascript:;" id="topic_sub_btn" class="btn btn-primary pull-right" style="margin-right: 18px;">发布新话题</a><span></span>
                            </form>
